MyGame.screens['game-play'] = (function(game, input, graphics, images, sounds) {
    ...
    function initialize() {
        ...
        if (_inIframe) {
            // Mostrar canvas directamente, saltar menú
            ...
            // SCORE_UPDATE cada 250ms → padre actualiza HUD de la arena
            ...
            // AUTO-FIRE: dispara automáticamente cada 380ms
            setInterval(function() {
    ...
    function endGame() {
        cancelNextRequest = true;
        // Si estamos en iframe, notificar al padre y no navegar
