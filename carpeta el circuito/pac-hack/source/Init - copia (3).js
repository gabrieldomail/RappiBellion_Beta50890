(function () {
    ...
    function requestAnimation() {
        ...
        animation = window.requestAnimationFrame(() => {
            ...
            const _elapsed    = (Date.now() - window._hackerStartTime) / 1000;
            ...
            if (window.parent && window.parent !== window && Math.random() < 0.1) {
     ...
     */
    function newGame() {
        window._hackerStartTime = Date.now(); // resetear timer al arrancar partida
