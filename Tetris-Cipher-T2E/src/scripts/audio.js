...
export class AudioUtils {
	...
	static #resolveAudioPath(soundFX) {
		// Siempre usar el directorio del pathname actual (funciona tanto en localhost
		// como en 127.0.0.1 y dentro de iframes). El bug original usaba href completo
		// incluyendo 'index.html' como directorio cuando indexOf retornaba -1.
		const dir = window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/") + 1);
		return dir + "assets/audio/" + soundFX;
	}
